        ...
        items: [
          ...
          BottomNavigationBarItem(
              ...
              icon: InkWell
                (
                  ...
                  child: Icon(Icons.bookmark_add_outlined,color: Colors.black)),label: ''),
          BottomNavigationBarItem(
              icon: InkWell(
                  onTap: () async{
                    if((
                  ...
                  child: Icon(Icons.arrow_back_ios_new,color: Colors.black)),label: ''),
          BottomNavigationBarItem(
              icon: InkWell(
                  onTap: () async{
                    if((
          ...
          BottomNavigationBarItem(
              icon: InkWell(
                  ...
                  child: Icon(Icons.arrow_forward_ios_outlined,color: Colors.black)),label: ''),
